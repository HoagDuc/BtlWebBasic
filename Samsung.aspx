<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Samsung.aspx.cs" Inherits="BtlWebBasic.Samsung" %>
...
<body>
	...
	<div class="breadscrum">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>Trang chủ</strong></a> / <a href="Danhmucsanpham.aspx"><strong>Danh mục sản phẩm</strong></a> / <a href="Samsung.aspx"><strong>Samsung</strong></a>
        </div>
    </div>
    <div class="container">
