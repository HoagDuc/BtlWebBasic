<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Oppo.aspx.cs" Inherits="BtlWebBasic.Oppo" %>
...
<body>
	...
	<div class="breadscrum">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>Trang chủ</strong></a> / <a href="Danhmucsanpham.aspx"><strong>Danh mục sản phẩm</strong></a> / <a href="Oppo.aspx"><strong>Oppo</strong></a>
        </div>
    </div>
    <div class="container">
