<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Danhmucsanpham.aspx.cs" Inherits="BtlWebBasic.Danhmucsanpham" %>
...
<body>
    <div class="header">
		<div class="header_top">
			<a href="Trangchu.aspx">
				<img width="200" height="80" src="images/logo.png" title="Shop" />
			</a>
	...
	<div class="breadscrum">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>Trang chủ</strong></a> / <a href="Danhmucsanpham.aspx"><strong>Danh mục sản phẩm</strong></a>
        </div>
    </div>
    <div class="container">
                        ...
                        <a href="Trangsanphamchitiet.aspx?id=<%# Eval("Id") %>">
                            <div class="sanpham_show">
                                ...
                                <div class="sanpham_gia">
                                    <strong class="name"><%# Eval("Name") %></strong>
                                    <p><%# Eval("Price") %> đồng</p>
                                </div>
                            </div>
                        </a>
	...
	<script>
		function search() {
			...
			alert(k);
			var sanpham = document.querySelectorAll("div.sidebar_two > div.sanpham");
			console.log(sanpham);
			for (let i = 0; i < sanpham.length; i++) {
				var name = sanpham[i].getElementsByClassName("name")[0].innerText;
				if (name.indexOf(k) < 0) {
					sanpham[i].remove
                }
            }
